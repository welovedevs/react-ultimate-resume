...
var SHARE_LINKS_DATA = Object.freeze({
  twitter: {
    icon: TwitterIcon,
    tooltipTranslation: /*#__PURE__*/_react.default.createElement(_reactIntl.FormattedMessage, {
  ...
  copyShareUrl: {
    icon: function icon(props) {
      ...
      return (/*#__PURE__*/_react.default.createElement(_copy_wrapper.CopyWrapper, {
          value: (_location = (typeof window === 'undefined' ? {} : window).location) === null || _location === void 0 ? void 0 : _location.href
        }, /*#__PURE__*/_react.default.createElement(ShareIcon, props))
      );
    },
    tooltipTranslation: /*#__PURE__*/_react.default.createElement(_reactIntl.FormattedMessage, {
