...
var UrlUploadFileDialogComponent = function UrlUploadFileDialogComponent(_ref) {
  ...
  if (typeof onFilesUpload === 'function') {
    return _react.default.createElement(_upload_file_dialog.UploadFileDialog, _extends({}, props, {
      onFileUploaded: onAdd
    }));
  }

  return _react.default.createElement(_url_input_dialog.UrlInputDialog, _extends({}, props, {
    onConfirm: onAdd
  }));
};
