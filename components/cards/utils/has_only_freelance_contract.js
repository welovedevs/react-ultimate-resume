...
var hasOnlyFreelanceContract = function hasOnlyFreelanceContract(contractTypes) {
  return !Array.isArray(contractTypes) && contractTypes === AVERAGE_DAILY_RATE_CONTRACT_TYPE || contractTypes.length === 1 && contractTypes[0] === AVERAGE_DAILY_RATE_CONTRACT_TYPE;
};
