...
var mapDreamJobFromJsonResume = function mapDreamJobFromJsonResume(jsonResume) {
  var _ref, _jsonResume$specific, _jsonResume$specific$, _jsonResume$specific2, _jsonResume$specific3, _jsonResume$specific4, _jsonResume$specific5, _jsonResume$specific6, _jsonResume$specific7, _jsonResume$specific8, _jsonResume$specific9, _jsonResume$specific10, _jsonResume$specific11;
  ...
  return {
    ...
    currentJobIssues: (_jsonResume$specific10 = jsonResume.specific) === null || _jsonResume$specific10 === void 0 ? void 0 : (_jsonResume$specific11 = _jsonResume$specific10.currentJob) === null || _jsonResume$specific11 === void 0 ? void 0 : _jsonResume$specific11.issues
  };
};
