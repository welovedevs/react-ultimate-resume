...
var BasicsFrontComponent = function BasicsFrontComponent(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_profile_card_padding_front.ProfileCardPaddedFront, null, /*#__PURE__*/_react.default.createElement(_center_content_container.CenterContentContainer, {
    customClasses: {
  ...
  }, data.summary), currentCityName && /*#__PURE__*/_react.default.createElement(_profile_card_front_typography.ProfileCardFrontTypography, {
    variant: "h4",
    component: "h3",
    classes: {
  ...
  }), data === null || data === void 0 ? void 0 : (_data$currentCity2 = data.currentCity) === null || _data$currentCity2 === void 0 ? void 0 : _data$currentCity2.name)), !(data === null || data === void 0 ? void 0 : data.personalDescription) && mode === 'edit' && /*#__PURE__*/_react.default.createElement(_no_data_button.NoDataButton, {
  ...
  }))), /*#__PURE__*/_react.default.createElement(_profile_card_actions.ProfileCardActions, null, /*#__PURE__*/_react.default.createElement(_profile_card_button.ProfileCardButton, {
