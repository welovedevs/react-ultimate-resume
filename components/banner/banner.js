...
var BannerComponent = function BannerComponent(_ref) {
  ...
  }, _react.default.createElement(_user_informations.UserInformations, null), _react.default.createElement(_social_actions.SocialActions, null, actionsButtons, mode === 'edit' && _react.default.createElement(_edit_button.EditButton, null), mode === 'edit' && _react.default.createElement(_customize_button.CustomizeButton, {
    customizationOptions: customizationOptions
