...
var _app_styles = _interopRequireDefault(require("./app_styles"));
...
var useStyles = (0, _reactJss.createUseStyles)(_app_styles.default);
...
var AppComponent = function AppComponent(_ref) {
  ...
  var theme = (0, _react.useMemo)(function () {
    return (0, _theme.buildTheme)(options === null || options === void 0 ? void 0 : options.theme);
  }, [options]);
