...
var Card = function Card(_ref) {
  var data = _ref.data,
      ...
      other = _objectWithoutProperties(_ref, ["data", "FrontComponent", "BackComponent"]);

  var classes = useStyles(other);
  return _react.default.createElement("div", {
    className: classes.card
  }, _react.default.createElement(FrontComponent, {
    data: data
  }), _react.default.createElement(BackComponent, {
    data: data
  }));
};
