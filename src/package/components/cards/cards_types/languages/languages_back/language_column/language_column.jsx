...
const LanguageColumnComponent = ({ component: Component = 'div', color, style, item: { value, language } = {}, children, itemsSize }) => {
    ...
    return (
        <Tooltip
            ...
            title={
                <>
                    <div className={classes.popperTitle}>{language}</div>
                    <div className={classes.popperTitle}>{`${value}%`}</div>
                </>
            }
        >
